...
# plotting predicted by actual for all models
...
treer <- r2(tree_pred_tuned, y_test)
...
p1=ggplot(compare_data, aes(x=name, y=value))+
  ...
  labs(x="Model",y="R2",title = "Comparing R-squared of all models")
p2=ggplot(compare_data, aes(x=name, y=mse_all))+
  geom_col()+
  coord_cartesian(ylim=c(0.0080,0.0095))+
  labs(x="Model",y="MSE",title = "Comparing MSE of all models")
p1+p2 / compare
```
## Discussion
