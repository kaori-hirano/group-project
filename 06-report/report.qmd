...
viz1 + viz2 + viz3 + 
  plot_annotation(title = 
                  "Civil Society Participation vs. Hypothesized Key Predictors by Region", caption = "Blue lines represent the best fit line for the respective plots.")
```
## Model Choice 
