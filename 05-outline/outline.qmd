...
we'll want to mention why we are using 2019 here or in methods
...
notes: when editing data, we should rename the region levels to the actual regions they represent. also, if we add more variables from happiness as suggested, we'll need to update the codebook
```{r data}
#| warning: false 
