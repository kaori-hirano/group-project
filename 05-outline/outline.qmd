...
# note: why are we displaying this?
head(total_2012)

# Cleaning the data and removing NA values
...
```{r clean-data-and-var-names}
cs <- new_total %>% rename(csrepress = v2csreprss, civil_war = e_civil_war, 
                           coup = e_pt_coup,
...
# Sub Saharan Africa, was used as baseline
