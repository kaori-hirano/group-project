...
```
  The names of used variables are shortened for further analysis. The year after 2011 are specifically selected because we mainly focus on the change before and after pandemic year. Leaving a larger volume of data gives a stronger comparison and makes the data equipped with a historic background. 
