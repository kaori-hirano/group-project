...
```{r data}
#| warning: false 
cs_full <- readRDS("/cloud/project/data/civil_society_final")
names(cs_full)
...
rf_feature_names <- colnames(cs[,c(3:6, 8:12)])
...
# plots the %incMSE for random forests which is most important variables
p1_rf + p2_rf
```
# Discussion
...
Civil society participation and participation in democracy were the top two predictors in all models, with region and social support being identified as top predictors by some of the models. 
